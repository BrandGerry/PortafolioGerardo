  ...
  return (
    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        <div className="mb-2">
          <h2 className="text-4xl font-bold inline border-b-4 border-sky-800 sm:text-5xl pb-1">
            Education
          </h2>
          <p className="py-6">Mis certificados</p>
        </div>
          ...
          {certificates.map((certificate, index) => (
            ...
            >
              <img
                ...
                alt="Certificate}"
                className="mx-auto w-full h-[200px] lg:h-[220px] rounded-md object-contain"
              />
            </div>
          ))}
        </Slider>
